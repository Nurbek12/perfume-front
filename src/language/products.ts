...
export const uz = {
    ...
    information: "Asosiy Ma'lumotlar",
    ...
    year: "Yili",
    shipping: "Davlati",
    sales_area: "Savdo huhudlari",
    brand: "Brendi",
    model: "Modeli",
    created: "Yuklangan vaqti",
    warranty: "Kafolat (oy)",
