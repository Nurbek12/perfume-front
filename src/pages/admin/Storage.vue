<template>
  <v-container fluid>
    <v-row justify="space-between" align="center">
        ...
        <v-col cols="12">
            <v-card flat border="">
                <v-card-title class="px-4 pt-3 font-weight-light">Приходы/Расходы продуктов</v-card-title>
    ...
    <v-dialog v-model="dialog" max-width="500px" persistent="" transition="fade-transition">
      <v-card flat="" border="" color="background">
        <v-card-title class="px-4 pt-3 pt-2 d-flex justify-space-between align-center">
          <span class="font-weight-light">Приход/Расход</span>
        ...
        <v-card-text class="px-4 pb-3">
          <v-row>
            <v-col cols="12">
              <v-select
                v-model="editedItem.product" item-title="name"
