            ...
            <v-col cols="12" sm="6">
                <v-skeleton-loader :loading="loading" type="article, avatar, text, paragraph" min-height="100%"
                    ...
                    <v-card variant="text" width="100%">
                        <v-card-title class="px-0 pt-0">{{ product?.[`title_${locale as 'uz'}`] }}</v-card-title> <!-- title_${locale as "uz"|"ru"|"en"} -->
                            ...
                            <v-table density="compact" hover class="rounded mt-3 border">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">{{ product?.category[`name_${locale as 'uz'}`] }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <v-table density="compact" hover>
                                <tbody>
                                    <tr v-for="c,i in product?.characteristics" :key="i">
                                        <td>{{ c.title[locale as 'uz'] }}</td><td class="text-right">{{ c.value[locale as 'uz'] }}</td>
                                    </tr>
                                </tbody>
                            </v-table>
                        </v-card-text>
                    ...
                    <v-card flat border width="100%">
                        ...
                        <v-card-text class="pt-2">
                            <span style="white-space: pre-line;">
                                {{ product?.[`description_${locale as 'uz'}`] }}
                            </span>
                        </v-card-text>
                    </v-card>
                </v-skeleton-loader>
                    ...
                    <v-form ref="form">
                        <v-row>
                            ...
                            <v-col cols="12" class="d-flex justify-end pt-1">
                                <v-btn flat @click="handleReview" color="primary">{{ t('products.send') }}</v-btn>
                            </v-col>
                        </v-row>
                    </v-form>
                </v-card-text>
